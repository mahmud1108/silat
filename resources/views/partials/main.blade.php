  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light-info elevation-4">
      ...
      <a href="index.php" class="brand-link">
        <img src="../gambar/AdminLogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
      ...
      <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            {{-- <img src="../gambar/user/<?php echo $datasss['user_gambar']; ?>" class="img-circle elevation-2"
              alt="User Image"> --}}
          </div>
          <div class="info">
            <a href="profil_tampil.php" class="d-block">
              {{ auth()->user()->user_username }}
            </a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="pertemuan_tampil.php" class="nav-link">
